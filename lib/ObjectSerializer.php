...
class ObjectSerializer
{
     ...
     * @param string $type   the MLVerifyType of the data
     * @param string $format the format of the MLVerify type of the data
     *
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\MLVerify\Client\Model\\' . $data->{$discriminator};
