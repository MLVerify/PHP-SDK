...
/**
 * IdChecksCheckModel Class Doc Comment
 *
 * @category Class
 * @description IdChecksCheckModel
 * @package  MLVerify\Client
 * @author   MLVerify Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IdChecksCheckModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IdChecksCheckModel';
     ...
     * Sets client_id
     *
     * @param string $client_id Gets or sets the client identifier.
     *
     * @return $this
     */
     ...
     * Sets person_id
     *
     * @param string $person_id Gets or sets the person identifier.
     *
     * @return $this
     */
