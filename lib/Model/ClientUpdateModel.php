...
/**
 * ClientUpdateModel Class Doc Comment
 *
 * @category Class
 * @package  MLVerify\Client
 * @author   MLVerify Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClientUpdateModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClientUpdateModel';
    ...
    public function setPhone1($phone1)
    {
        ...
        if (!is_null($phone1) && (!preg_match("/^[0-9-+()\\s]+$/", $phone1))) {
            throw new \InvalidArgumentException("invalid value for $phone1 when calling ClientUpdateModel., must conform to the pattern /^[0-9-+()\\s]+$/.");
        }
    ...
    public function setPhone2($phone2)
    {
        ...
        if (!is_null($phone2) && (!preg_match("/^[0-9-+()\\s]+$/", $phone2))) {
            throw new \InvalidArgumentException("invalid value for $phone2 when calling ClientUpdateModel., must conform to the pattern /^[0-9-+()\\s]+$/.");
        }
    ...
    public function setWebAddress($web_address)
    {
        ...
        if (!is_null($web_address) && (!preg_match("/((www\\.|(http|https|)+\\:\/\/)?[&#95;.a-z0-9-]+\\.[a-z0-9\/&#95;:@=.+?,##%&~-]*[^.|\\'|\\# |!|\\(|?|,| |>|<|;|\\)])/", $web_address))) {
            throw new \InvalidArgumentException("invalid value for $web_address when calling ClientUpdateModel., must conform to the pattern /((www\\.|(http|https|)+\\:\/\/)?[&#95;.a-z0-9-]+\\.[a-z0-9\/&#95;:@=.+?,##%&~-]*[^.|\\'|\\# |!|\\(|?|,| |>|<|;|\\)])/.");
        }
