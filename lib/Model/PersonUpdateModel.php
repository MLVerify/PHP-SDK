...
/**
 * PersonUpdateModel Class Doc Comment
 *
 * @category Class
 * @package  MLVerify\Client
 * @author   MLVerify Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PersonUpdateModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PersonUpdateModel';
    ...
    public function setDobDay($dob_day)
    {
        ...
        if (!is_null($dob_day) && ($dob_day > 31)) {
            throw new \InvalidArgumentException('invalid value for $dob_day when calling PersonUpdateModel., must be smaller than or equal to 31.');
        }
        if (!is_null($dob_day) && ($dob_day < 1)) {
            throw new \InvalidArgumentException('invalid value for $dob_day when calling PersonUpdateModel., must be bigger than or equal to 1.');
        }
    ...
    public function setDobMonth($dob_month)
    {
        ...
        if (!is_null($dob_month) && ($dob_month > 12)) {
            throw new \InvalidArgumentException('invalid value for $dob_month when calling PersonUpdateModel., must be smaller than or equal to 12.');
        }
        if (!is_null($dob_month) && ($dob_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $dob_month when calling PersonUpdateModel., must be bigger than or equal to 1.');
        }
